...
Built based on: [eleventy-base-blog](https://github.com/11ty/eleventy-base-blog)
...
>[!NOTE]
>The sections below are copied directly from the eleventy-base-blog repository.
